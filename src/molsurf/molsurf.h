...
typedef REAL_T molsurf_POINT[3];
...
typedef struct {
        molsurf_POINT center, uv;       /* torus center and axis unit vector */
        REAL_T rad;
        int a1, a2;
...
typedef struct cusp_pair {
	molsurf_POINT circle_center, circle_axis, vert1, vert2;
	REAL_T circle_rad;
...
REAL_T molsurf(REAL_T *xcrds, REAL_T *ycrds, REAL_T *zcrds,
		REAL_T *radii,
		size_t num_atoms, REAL_T probe_rad);//dc: forward declaration of routine used outside of molsurf.c
